 ...
 * @LastEditTime: 2022-03-21 13:46:26
        ...
        <div class="login-box">
            ...
            <div class="box-right">
                <div class="form">
                    ...
                    <input type="submit" id="submit" value="submit" @click="handleLogin()">
                </div>
            </div>
        </div>
    </div>
...
.login{
    ...
    align-items: center;
    height: 100vh;
    background-image: linear-gradient(to bottom right, #bdbef8,#bbb7fe);
}
.login-box{
    width: 640px;
    height: 320px;
...
.box-right{
    ...
    box-shadow: 0 0 40px 16px rgba($color: #000000, $alpha: 0.2);
    color: #f1f1f2;
    width: 50%;
}
.form{
